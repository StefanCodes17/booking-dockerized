...
import { EyeIcon, EyeOffIcon, LockClosedIcon, RefreshIcon } from '@heroicons/react/solid';
          ...
          <form className="mt-8 space-y-6" onSubmit={login}>
            ...
            <div className="flex items-center justify-end">
              <div className="text-sm">
                <NavLink to="/register" className="font-medium text-brown-900 hover:text-brown-800">
